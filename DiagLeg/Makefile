...
#                             -------------------
#        begin                : 2012-06-18
#        copyright            : (C) 2012 by JS/FAO
#        email                : doublebyte@lavabit.com
# ***************************************************************************/
# 
#/***************************************************************************
# *                                                                         *
...
# translation
SOURCES = diagleg.py ui_diagleg.py __init__.py diaglegdialog.py
#TRANSLATIONS = i18n/helloworld_en.ts
TRANSLATIONS = 
...
PY_FILES = diagleg.py diaglegdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_diagleg.py
